...
BIN_159b_Flower=SF_2378_flower_bin.fa
BIN_159b_Leaf=SF_2378_leaf_bin.fa
BIN_159b_Pod=SF_2378_pod_bin.fa
BIN_159b_Seed=SF_2378_seed_bin.fa

TRI_159b_Flower=SF_2378_flower_tri.fa
TRI_159b_Leaf=SF_2378_leaf_tri.fa
TRI_159b_Pod=SF_2378_pod_tri.fa
TRI_159b_Seed=SF_2378_seed_tri.fa

OUT_159b_Flower=SF_Evi_2378_Flower
OUT_159b_Leaf=SF_Evi_2378_Leaf
OUT_159b_Pod=SF_Evi_2378_Pod
OUT_159b_Seed=SF_Evi_2378_Seed

PERLS_159b=(\
'if(/\>/){$a++;print ">2378_Flower_$a\n"}else{print;}' \
'if(/\>/){$a++;print ">2378_Leaf_$a\n"}else{print;}' \
'if(/\>/){$a++;print ">2378_Pod_$a\n"}else{print;}' \
'if(/\>/){$a++;print ">2378_Seed_$a\n"}else{print;}' \
)

RENAME_159b_Flower=RENAME_SF_2378_Flower.fa
RENAME_159b_Leaf=RENAME_SF_2378_Leaf.fa
RENAME_159b_Pod=RENAME_SF_2378_Pod.fa
RENAME_159b_Seed=RENAME_SF_2378_Seed.fa
