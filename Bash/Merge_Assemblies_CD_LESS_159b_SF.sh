...
BIN_159b_Flower=SF_159b_flower_bin.fa
BIN_159b_Leaf=SF_159b_leaf_bin.fa
BIN_159b_Pod=SF_159b_pod_bin.fa
BIN_159b_Seed=SF_159b_seed_bin.fa

TRI_159b_Flower=SF_159b_flower_tri.fa
TRI_159b_Leaf=SF_159b_leaf_tri.fa
TRI_159b_Pod=SF_159b_pod_tri.fa
TRI_159b_Seed=SF_159b_seed_tri.fa

OUT_159b_Flower=SF_Evi_159b_Flower
OUT_159b_Leaf=SF_Evi_159b_Leaf
OUT_159b_Pod=SF_Evi_159b_Pod
OUT_159b_Seed=SF_Evi_159b_Seed

PERLS_159b=(\
'if(/\>/){$a++;print ">159b_Flower_$a\n"}else{print;}' \
'if(/\>/){$a++;print ">159b_Leaf_$a\n"}else{print;}' \
'if(/\>/){$a++;print ">159b_Pod_$a\n"}else{print;}' \
'if(/\>/){$a++;print ">159b_Seed_$a\n"}else{print;}' \
)

RENAME_159b_Flower=RENAME_SF_159b_Flower.fa
RENAME_159b_Leaf=RENAME_SF_159b_Leaf.fa
RENAME_159b_Pod=RENAME_SF_159b_Pod.fa
RENAME_159b_Seed=RENAME_SF_159b_Seed.fa
