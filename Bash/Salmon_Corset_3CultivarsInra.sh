...
# qx --no-scratch -c 16 -t 10:00:00 -A norfab '/home/leandro/Scripts/Salmon_Corset_3CultivarsInra.sh'

#================#
# Directionaries #
#================#

DIR_ASS=/faststorage/project/norfab/20190903_Transcriptomics/Fasta/Evigene
DIR_IND=/faststorage/project/norfab/20190903_Transcriptomics/Fasta/Evigene/Salmon/Index
DIR_OUT=/faststorage/project/norfab/20190903_Transcriptomics/Fasta/Evigene/Salmon/Output
...
echo "The index is already done"
echo "Now commencing mapping"

for (( I = 0; I < 36; ++I )); do
        echo "Quantifying ${NAME[I]}"
        salmon quant -l A --dumpEq --writeOrphanLinks -p $CORES -i $DIR_IND/$i -1 $DIR_REA/${j[I]} -2 $DIR_REA/${k[I]} -o $DIR_OUT/${NAME[I]}
        echo "Done"
done
